...
x_train, x_test, y_train, y_test = train_test_split(x_train, y_train, test_size=0.25, random_state=7777)
...
def train_model(x_data, y_data, k):
    ...
    for train_idx, val_idx in k_fold.split(x_data):
        ...
        callbacks_list = [tf.keras.callbacks.ReduceLROnPlateau(monitor='val_loss',patience=4,factor=0.9)]
        model.fit(x_train, y_train, epochs=30, batch_size=32, validation_data=(x_val, y_val), callbacks=callbacks_list)
